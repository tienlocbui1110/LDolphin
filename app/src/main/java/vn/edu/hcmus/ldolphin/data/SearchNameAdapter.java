...
public class SearchNameAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchNameAdapter(Activity activity, List<Article> articleList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                return new SearchNameAdapter.ViewHolderProgressBar(item);
        }
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        switch (holder.getItemViewType()) {
            ...
            case VIEW_TYPE_PROGRESS:
                viewHolderProgressBar = (SearchNameAdapter.ViewHolderProgressBar) holder;
                // Do with
